...
const AboutUs = () => {
    ...
    return(
        <div className='aboutus'>
            <h2>About Us</h2>
            <p>Four friends set out on an adventure to find a powerful artifact thought long lost - the Staff of Thay, 
            ...
            <div className='portrait'>
                <img src='/images/sarah.png' alt='painting of a dwarf paladin' />
                <p><strong>Sarah Uhl</strong></p>
                <p>Level 6 Dwarf Oath of Devotion Paladin</p>
            </div>
        </div>
    )
}
